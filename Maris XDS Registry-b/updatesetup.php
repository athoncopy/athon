...
$deleteREG_config = "DELETE FROM CONFIG_B";
$REG_delete_config = query_exec2($deleteREG_config,$connessione);
$insertREG_config = "INSERT INTO CONFIG_B (CACHE,PATIENTID,LOG,STAT,FOLDER,STATUS) VALUES ('$REG_cache','$REG_patient','$REG_log','$REG_stat','$REG_folder','$REG_status')";
