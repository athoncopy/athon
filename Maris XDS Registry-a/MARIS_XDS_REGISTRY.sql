...
-- 
-- Host: localhost
-- Generato il: 04 Lug, 2007 at 12:31 PM
...
CREATE TABLE `AuditableEvent` (
  ...
  `user_` varchar(64) NOT NULL default '',
  PRIMARY KEY  (`id`)
...
INSERT INTO `CONFIG` (`WWW`, `CACHE`) VALUES 
('/MARIS_xds3/xdsServices2/registry/', 'O');
...
('A', 'dcm4chee@rad.unipd.it', 'xds@rad.unipd.it');
...
(1, '10.135.0.115', 80, 'SUBMISSION', 'A', 'NORMAL'),
(2, '10.135.0.115', 80, 'QUERY', 'A', 'NORMAL');
