...
include_once("reg_atna.php");
	...
	$ris_query = query_exec2($INSERT_atna_query,$connessione);
...
include_once("reg_atna.php");
	...
	$message=createExportEvent($eventOutcomeIndicator,$ip_registry,$ip_consumer,$SUID,$idName,$pid,$pna);

	require_once('./lib/syslog.php');
        $syslog = new Syslog();
        $logSyslog=$syslog->Send($ATNA_host,$ATNA_port,$message);
	...
	$ris_export = query_exec2($INSERT_atna_export,$connessione);*/
